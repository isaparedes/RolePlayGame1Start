...
namespace Library
{
    public class Elfo
    {
        ...
        // Método para aumentar la vida máxima del Elfo
        ...
        public void AgregarElemento(Elemento elemento)
        {
            ...
            if (elemento != null && !this.listaElementos.Contains(elemento))
            {
                ...
                // Si el elemento aumenta la vida máxima, actualizamos la vida máxima del Elfo
        ...
        public void QuitarElemento(Elemento elemento)
        {
            ...
            if (elemento != null && this.listaElementos.Contains(elemento))
            {
                ...
                // Si el elemento disminuye la vida máxima, actualizamos la vida máxima del Elfo
                if (elemento.GetVidaMaxima() > 0)
                {
                    AumentarVidaMaxima(-elemento.GetVidaMaxima());
                }
