...
namespace Library
{
    public class Enano
    {
        ...
        // Método para aumentar la vida máxima del Enano
        public void AumentarVidaMaxima(int cantidad)
        {
            this.vidaBase += cantidad;
            Console.WriteLine($"{this.nombre} ha aumentado su vida máxima en {cantidad} puntos. Ahora su vida máxima es {this.vidaBase}.");
        }
        ...
        public void AgregarElemento(Elemento elemento)
        {
            ...
            if (elemento != null && !this.listaElementos.Contains(elemento))
            {
                ...
                // Si el elemento aumenta la vida máxima, actualizamos la vida máxima del Enano
        ...
        public void QuitarElemento(Elemento elemento)
        {
            ...
            if (elemento != null && this.listaElementos.Contains(elemento))
            {
                ...
                // Si el elemento disminuye la vida máxima, actualizamos la vida máxima del Enano
                if (elemento.GetVidaMaxima() > 0)
                {
                    AumentarVidaMaxima(-elemento.GetVidaMaxima());
                }
